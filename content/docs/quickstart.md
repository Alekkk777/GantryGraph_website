...
| Keep credentials out of the LLM context | [Guardrails & security](concepts/guardrails.md) |
| Block dangerous shell commands | [Guardrails & security](concepts/guardrails.md) |
